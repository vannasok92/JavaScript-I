...
let lastCar = 0;
console.log("Last car in the inventory: car_make: " + inventory[inventory.length-1].car_make + ', car_model:'+ inventory[inventory.length-1].car_model);
...
carModels.sort();
console.log('Sorted car model: '+carModels);
...
console.log('Show BMW & Audi: '+ JSON.stringify(BMWAndAudi));